...
export const MapScreen: React.FC<MapScreenProps> = ({
  ...
  return (
    <div className="relative h-[calc(100vh-120px)] w-full overflow-hidden bg-[#e8e2d5] flex flex-col">
      ...
      <div className="absolute top-4 left-4 right-4 z-20 space-y-2.5 max-w-lg mx-auto">
        <div className="relative shadow-md rounded-2xl">
          ...
          <input
            ...
            placeholder="Find temples, memorials, sacred groves..."
            ...
            <div className="mt-3 pt-3 border-t border-[#f0ece1] flex items-center justify-between">
              <div className="text-xs text-[#6b665e]">
                <span className="font-semibold text-[#c14e2f]">
                  {activePlace.verifiedGuideIds.length} Verified Guides
                </span>{' '}
                available
              </div>
