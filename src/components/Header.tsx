        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <div className="relative">
            ...
            {langMenuOpen && (
              <div
                role="menu"
                className="absolute right-0 top-full mt-1.5 w-44 bg-white rounded-2xl shadow-xl border border-[#e8e2d5] py-1 z-50 animate-in fade-in slide-in-from-top-1"
              >
          ...
          {/* Portal shortcuts: the badge mirrors the verified role and cannot be toggled */}
          {user.role === 'admin' && (
            <button
