...
'Poser une question au compagnon culturel': 'Ask the cultural companion',
  ...
  'Sites enregistrés, itinéraires sauvegardés et demandes posées': 'Saved sites, saved itineraries and requests placed',
...
'Rayon < {max} km': 'Radius < {max} km',
  ...
  'Aucune fiche de lieu n’est disponible : rien à proposer pour l’instant.': 'No place sheet is available: nothing to propose for now.',
  'Matinée': 'Morning',
  'Mi-journée': 'Midday',
  'Fin de journée': 'Late afternoon',
  'Visite Culturelle': 'Cultural Visit',
  'Immersion patrimoniale au cœur des traditions.': 'Heritage immersion at the heart of local traditions.',
  'Enregistré !': 'Saved!',
  'Enregistrer': 'Save',
  ...
  'Sites enregistrés': 'Saved Sites',
  'Médiateurs contactés': 'Mediators Contacted',
  'Itinéraires enregistrés': 'Saved Itineraries',
  'Tous les récits': 'All Stories',
  'Badges Obtenus': 'Earned Badges',
  'Enregistré': 'Saved',
  'Aucun badge décerné sur ce compte. L’application n’attribue pas encore de distinction.':
    'No badge has been awarded on this account. The application does not hand out distinctions yet.',
  'Débloqué': 'Unlocked',
  'Verrouillé': 'Locked',
  ...
  'Erreur lors de la connexion Google': 'Google sign-in error',
  'Format d’adresse email invalide.': 'Invalid email address format.',
  'Email ou mot de passe incorrect.': 'Incorrect email or password.',
  'Ce compte a été désactivé.': 'This account has been disabled.',
  'Cette adresse email est déjà utilisée.': 'This email address is already in use.',
  'Mot de passe trop simple.': 'Password too weak.',
  'Trop de tentatives. Réessayez dans un instant.': 'Too many attempts. Try again in a moment.',
  'Connexion réseau impossible. Vérifiez votre connexion.': 'Network connection unavailable. Check your connection.',
  'Ce mode de connexion n’est pas activé sur ce projet.': 'This sign-in method is not enabled on this project.',
  'Le service de connexion a répondu une erreur. Réessayez.': 'The sign-in service returned an error. Try again.',
  'Fenêtre de connexion fermée avant la fin.': 'Sign-in window closed before it finished.',
  'Un compte existe déjà avec cette adresse, via un autre mode de connexion.': 'An account already exists with this address, via another sign-in method.',
  ...
  'Vous encadrez des visites ? Demander un agrément': 'You lead tours? Request accreditation',
  'Retour à l’accès voyageur': 'Back to traveler access',
